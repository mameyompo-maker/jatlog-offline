...
var TEXTOS = {
  ...
  pt: {
    ...
    'mes.campo': 'Mês',
    'mes.antes': 'Up to Jul/26 (total acumulado)',
  ...
  en: {
    ...
    'mes.campo': 'Month',
    'mes.antes': 'Up to Jul/26 (cumulative total)',
  ...
  ja: {
    ...
    'mes.campo': '月',
    'mes.antes': 'Up to Jul/26(累計)',
    'mes.falta': '月を選んでください。',
    'mes.botao': '次へ',
    'mes.aCarregar': 'Source ID リストを読み込んでいます…',
    'mes.semCadastro': 'Source ID リストを取得できず、この端末にも控えがありません。一度だけ通信できる場所で開いてください。',
