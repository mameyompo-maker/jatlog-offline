...
var TEXTOS = {
  ...
  en: {
    ...
    'local.local': 'Site',
    'local.registoPor': 'Recording by {o}',
  ...
  ja: {
    ...
    'local.semCadastro': 'この拠点の台帳を取得できず、この端末にも控えがありません。一度だけ、通信できる場所で開いてください。',
    ...
    'busca.hatenaAusente': '「?」ブロックはまだ台帳にありません。',
    'busca.semCadastro': 'この端末にはまだ台帳がありません。一度だけ、通信できる場所で開いてください。',
